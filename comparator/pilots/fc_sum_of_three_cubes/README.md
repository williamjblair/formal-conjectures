...
- Comparator, final Lean 4.33 commit: `c0c5a52d2aff92b457c3e5ed4a68c1ebc5795809`
...
Build the pinned Comparator commit recorded above. Its manifest pins the matching
Lean 4.33 exporter, then run:
