...
def repository_snapshot(case: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "repository": {
            "host": "github.com", "owner": "google-deepmind", "name": "formal-conjectures",
            "url": "https://github.com/google-deepmind/formal-conjectures",
        },
        "pull_request": {"number": number, "url": f"https://github.com/google-deepmind/formal-conjectures/pull/{number}"},
...
def retained_core_artifacts(
    ...
    if pr != {
        "number": case["pr"],
        "url": f"https://github.com/google-deepmind/formal-conjectures/pull/{case['pr']}",
    ...
    variables = {
        "owner": "google-deepmind", "name": "formal-conjectures", "number": case["pr"],
...
def build_case(name: str, case: dict[str, Any], generator: dict[str, Any]) -> None:
    ...
    receipt = {
        ...
        "variables": {"owner": "google-deepmind", "name": "formal-conjectures", "number": case["pr"]},
