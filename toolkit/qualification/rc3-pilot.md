...
**#5397.** Fox and Kleitman's own preprint (§6.3, p. 13) states Conjecture 5 "for each positive integer n", where n is the number of variables. The PR's positive-arity guard therefore matches the primary source, not only Green's account. One point remains outside this PR's change: the primary conjecture covers prime-power moduli while the FC statement follows Green's prime restatement. The PR's corrected Rado page range, 424–480, matches zbMATH (Zbl 0006.14603; JFM 59.0896.13). Crossref indexes the final section, pp. 471–480, as a separate record.
